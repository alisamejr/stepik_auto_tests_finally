...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            marks=pytest.mark.xfail(reason="Bug found on this affer"),
        ),
...
@pytest.mark.xfail(
    reason="Сообщение об успехе должно появляться после добавления товара"
)
...
@pytest.mark.xfail(reason="Сообщение об успехе не должно исчезать")
